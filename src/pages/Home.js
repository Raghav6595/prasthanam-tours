    ...
    return (
        <div>
            ...
            <div className="w-full min-h-[50vh] flex flex-col items-center justify-center text-center dark:bg-gray-900">
                ...
                {/* <h1 className="text-4xl font-bold bg-gradient-to-r from-teal-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                    Go with the Flow
                </h1>
                <h1 className="text-4xl font-bold bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">
                    Go with the Flow
                </h1>
                <h1 className="text-4xl font-bold bg-gradient-to-r from-green-400 via-lime-400 to-yellow-500 bg-clip-text text-transparent">
                    Go with the Flow
                </h1> */}
